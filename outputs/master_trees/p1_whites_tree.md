...
open-vs-blind or Old-World-vs-New-World paired grids, and single-wine isolation questions. *(Updated
2026-08-06 residual sweep: the **two-variety paired grid** — 2014 P1 Q3's construction — was
originally on this list, but it now routes cleanly to **Branch 4's paired-grid sub-branch**, which
claims it as evidence. Only a grid whose pairing key is stated nowhere in the stem stays unroutable.)*
...
Italy 9%, Spain 7%, South Africa 6%, **New Zealand** (omitted from the original tally despite
supplying wines in 6+ P1 flights — 2016 P1 Q5, 2017 P1 Q2, 2018 P1 Q1, 2024 P1 Q1, 2026 P1 Q1, plus
half of the 2014 P1 Q3 paired grid, now routed via Branch 4; treat it alongside South Africa, not off-list). Open with
Chardonnay + Riesling and a French default, then widen.
...
**Same-producer gate (2026-08-06 routing sweep):** "same grape variety" also fires on stems that additionally say "**same producer**" (2021 P1 Q3, 2022 P1 Q1). Same-producer is the more specific constraint and wins — route those stems to **Branch 7** below, not to the sub-branches here. 2021 P1 Q3's misses (Wachau Federspiel/Smaragd) came from this branch's leaves being applied to a producer-ladder stem.

**Multi-pair gate (2026-08-06):** when the stem declares the flight as *pairs* ("Wines 1-2, 3-4 and 5-6 are pairs. Each pair is made from the same single grape variety" — 2024 P1 Q1), treat each pair with the 2-wine leaves below, applied per pair, rather than forcing the whole flight through the 3-4-wine sub-branch. A flag from a single question — use it to widen, not to predict.
...
- **Evidence:** 2018 P1 Q1, 2025 P1 Q2, 2024 P1 Q1, 2021 P1 Q2, 2019 P1 Q1, 2023 P1 Q1, 2026 P1 Q2. *(2018 P1 Q3 was mis-filed here until 2026-08-06 — it is a 2-wine question and now lives in the 2-wine sub-branch below; the mis-filing is what kept Riesling out of the 2-wine tiers. 2021 P1 Q3 was removed from this evidence list in the 2026-08-06 routing sweep for the same defect — it is a 2-wine, same-producer question and now lives in Branch 7.)*
- **Maturity-weighting note (2026-08-06):** the 2-wine maturity leaf's promotion (Riesling/Chenin STRONG when maturity is explicitly marked) generalizes to 3-4-wine flights: 2021 P1 Q2 put 36 of 75 marks on quality+maturity and the answer was Chenin Blanc, the maturity leaf's #2 variety. When a 3-4-wine same-variety stem weights maturity that heavily, promote Riesling and Chenin one tier before tasting.
- **Region distribution:** STRONG SIGNAL: Burgundy/Chablis, California, Margaret River, New Zealand (Marlborough), South Africa for Chardonnay; Mosel, Rheingau/Franken, Alsace, Wachau (Austria), Clare Valley/Eden Valley for Riesling; Loire/Marlborough/Bordeaux for Sauvignon Blanc. PLAUSIBLE: Loire/South Africa for Chenin; Bordeaux/Hunter Valley/Chile for Semillon; Italy (IGT Dolomiti/Alto Adige) for Chardonnay — confirmed as a real (if minor-volume) Chardonnay origin by 2026 P1 Q1; **New Zealand (Marlborough, Central Otago) for Riesling — twice attested (2013 P1 Q3, 2014 P1 Q2) yet absent from every Riesling region list until the 2026-08-06 routing sweep**. CURVEBALL: Alsace/Oregon or Alto Adige for Pinot Gris; USA (Napa/Rutherford) for Sauvignon Blanc — a single attestation (2023 P1 Q1), a flag to widen, not a predictor.

#### Sub-branch: 2-wine same-variety questions with winemaking emphasis
- **Leaf (default):** STRONG SIGNAL: Chardonnay, Chenin Blanc. PLAUSIBLE: Riesling, Pinot Gris, Sauvignon Blanc. CURVEBALL: Semillon, **Marsanne** (2012 P1 Q4 — Nagambie Lakes/Victoria museum-style vs Crozes-Hermitage Blanc; before 2026-08-06 no 2-wine tier contained Marsanne even though Branch 2 and the F2/F3 pack families both carry it, making that flight a zero-probability event under this leaf — the exact 2018 P1 Q3 defect class. A single attestation: a flag to widen, not a predictor. Note "same *predominant* grape variety" wording is also a soft blend cue — a Marsanne-led Rhône blend can sit on a same-variety stem).
- **Leaf (stem marks "state of maturity" — or maturity/development is explicitly part of a per-wine ask):** STRONG SIGNAL: **Riesling**, Chenin Blanc. PLAUSIBLE: Chardonnay, Semillon, Pinot Gris (promoted from CURVEBALL 2026-08-06 — cross-country Pinot Gris flights are attested three times: 2012 P1 Q2, 2016 P1 Q3, 2017 P1 Q2, the last landing in this very leaf), **Sauvignon Blanc** (back-filled 2026-08-06 residual sweep — 2024 P1 Q1's third pair was a young-vs-bottle-aged **Marlborough SB ×2** maturity ladder that this leaf zero-weighted while the sibling different-countries leaf held SB at STRONG and the default leaf at PLAUSIBLE; the "development-arc" rationale must not exclude a global benchmark white whose ageing arc — pungent pyrazine/passion-fruit youth → asparagus/tinned-pea/honeyed toast maturity — is perfectly legible and gradeable). *Boundary rule (2026-08-06, from the 2017 P1 Q5 routing fork): "state of maturity **now**" or per-wine maturity/development fires this leaf; "capacity/potential to improve in the bottle" alone is an ageability ask, NOT a maturity ask — that stays in the default leaf.* *Rationale: an explicitly maturity-weighted part (c) promotes the development-arc whites — the varieties whose transformation with age is legible and gradeable. Riesling has the single clearest arc of any white (lime/linear youth → petrol/toast/honey maturity, with no oak to confuse the read), Chenin the second (wax/lanolin/quince), and Hunter Semillon the classic curveball version (neutral young → toast/lanolin with a decade). Do NOT read "winemaking" in the same ask as a vote against Riesling: for a Riesling pair the winemaking discussion is about what was NOT done (no oak, no malo, RS decisions, vessel) plus maturity, and that is exactly what the examiners marked in 2018 P1 Q3. Expect the pair to be split young-vs-mature and possibly dry-vs-sweet, and be alert that both wines may silently share a country even when the stem doesn't say so.*
...
- **Region distribution:** STRONG SIGNAL: Burgundy vs New World Chardonnay; Loire vs South Africa Chenin; Loire vs Marlborough Sauvignon Blanc; **Germany intra-country Riesling ladder (Rheingau dry GG vs Mosel sweet Prädikat, split young-vs-mature — 2018 P1 Q3)**; **Marlborough intra-country SB maturity pair (young vs bottle-aged, both NZ — 2024 P1 Q1)**. PLAUSIBLE: Alsace vs Italy/New World Pinot Gris; Mosel vs Clare/Eden or Alsace vs Germany for a cross-country Riesling pair. CURVEBALL: Hunter Valley vs Bordeaux Blanc/Chile Semillon; Nagambie Lakes (Victoria) vs Crozes-Hermitage/N. Rhône for a Marsanne pair (2012 P1 Q4).
...
**Historical frequency:** 11 of 40 P1 questions use this structure (2016 P1 Q1, 2016 P1 Q4, 2017 P1 Q1, 2017 P1 Q3, 2021 P1 Q1, 2021 P1 Q4, 2022 P1 Q2, 2022 P1 Q3, 2023 P1 Q3, 2024 P1 Q3, 2025 P1 Q3). The matrices repeatedly show France as the default answer, then Italy, USA, Australia, South Africa, Spain. *(2016 P1 Q2 was dual-listed here and in Branch 1 until 2026-08-06; its stem is "same country **and the same grape variety**" and its true home is Branch 1's 2-wine same-country leaf, which cites it as founding evidence — removed from this list.)*

#### Sub-branch: same country, different single varieties, origin-heavy
- **Leaf:** STRONG SIGNAL: France, Italy. PLAUSIBLE: South Africa, Australia, USA, **Spain** (promoted from CURVEBALL 2026-08-06 — Spain has delivered two full same-country flights, 2013 P1 Q1 and 2016 P1 Q4, and the F2 pack already treated Spanish breadth as a standard working prior). CURVEBALL: **Austria** (added 2026-08-06 — one attested same-country flight, 2013 P1 Q2 (Kamptal Grüner Veltliner + Wachau Riesling); the F2 pack's Germany/Austria universe contained it but this leaf's country tiers omitted Austria entirely, so the gate's honesty never reached the candidate set).
- **Evidence:** 2021 P1 Q1, 2025 P1 Q3, 2022 P1 Q3, 2023 P1 Q3, 2022 P1 Q2, 2021 P1 Q4, 2016 P1 Q4.
- **Variety distribution:** STRONG SIGNAL in France: Riesling (Alsace), Pinot Gris (Alsace — attested 2011 P1 Q1, 2021 P1 Q1 yet missing from this list until 2026-08-06 while Alsace Riesling was present), Chenin Blanc (Loire), Sauvignon Blanc (Loire), Melon de Bourgogne/Muscadet, Chardonnay, Savagnin, Marsanne/Roussanne-adjacent blends. PLAUSIBLE in France: dry Muscat (Alsace) — the fourth noble variety, three corpus appearances (2011 P1 Q1, 2017 P1 Q4, 2023 P1 Q2) and absent from every P1 leaf until 2026-08-06. STRONG SIGNAL in Italy: Pinot Grigio, Gewurztraminer Alto Adige, Carricante/Etna Bianco. CURVEBALL in Italy: Piedmont whites — Arneis (Roero, 2017 P1 Q3), Cortese (Gavi, 2013 P1 Q5), Moscato d'Asti (sweet frizzante, 2019 P1 Q2) — each a single attestation, but before 2026-08-06 the Italy universe contained no Piedmont still white at all. PLAUSIBLE in South Africa: Chenin Blanc, Chardonnay, Sauvignon Blanc. PLAUSIBLE in Australia/USA: Riesling, Chardonnay, Marsanne, Pinot Gris, Moscato, Viognier (Eden Valley — twice attested, 2014 P1 Q1 and 2024 P1 Q2, yet Australia was never named for Viognier anywhere in the P1 artifacts before 2026-08-06). PLAUSIBLE in Spain: Viura, Albarino, Godello, Sherry-adjacent whites. CURVEBALL in Austria: Grüner Veltliner (Kamptal), Riesling (Wachau) — 2013 P1 Q2.
...
- **Hidden-blend flag (2026-08-06):** "different single varieties" wording does not guarantee every wine is varietal — 2014 P1 Q1 slipped a Margaret River Sauvignon Blanc-Semillon blend into a no-blend-cue Australian same-country flight, outside this leaf's candidate set by definition. A single attestation: a flag to widen (keep the sibling blends sub-branch's regional blends mentally alive), not a predictor.

#### Sub-branch: same country, all blends or blend-led
- **Trigger gate (2026-08-06 routing sweep):** this sub-branch requires the stem to link the wines to **one country** AND flag blends. A blend stem with *no* country link — "blends of the same two grape varieties" (2025 P1 Q1, answered Pessac-Léognan FR + Margaret River AU) — is the cross-country blend-family construction: route it to the **pack's F3a branch** (same blend family, different origins: Bordeaux-Blanc family ⇒ Bordeaux + Margaret River + Chile/South Africa; Rhône-Blanc family ⇒ N/S Rhône + Languedoc + California). Filing cross-country blend stems here is what mis-contained 2025 P1 Q1 in the routing sweep.
...
- **Evidence:** 2016 P1 Q1, 2024 P1 Q3. *(2019 P1 Q1 and 2025 P1 Q1 were removed from this evidence list 2026-08-06: 2019 P1 Q1's stem says "two different countries" with one variety common to all — its home is Branch 1's different-countries leaf, which already cites it; 2025 P1 Q1's stem imposes no country constraint at all — it belongs to pack F3a per the gate above. Both citations violated this sub-branch's own same-country trigger.)*
- **Region distribution:** STRONG SIGNAL: Pessac-Leognan, Graves, Margaret River SB/Sem, northern/southern Rhone white blends, Chateauneuf-du-Pape Blanc. PLAUSIBLE: Jurancon, Rioja Blanco, Chile (Maule Valley) for Semillon-led blends. CURVEBALL: Georgian qvevri-like or biologically aged whites if the stem downweights exact origin. *(Jurançon tier reconciled 2026-08-06: the F3 pack had it at STRONG while this leaf had PLAUSIBLE — one corpus appearance (2024 P1 Q3) supports PLAUSIBLE at most; the pack has been brought down to match.)*
...
**Which sub-branch (2026-08-06 routing sweep):** the word "region" alone does not decide. If the wines are the **same variety** (or the stem is a quality/vintage ladder), use the single-variety ladder sub-branch below. If the stem pairs "same region" (or "same country and region") with **different / multiple single grape varieties**, use the new same-region-different-varieties sub-branch — the 2011 P1 Q1 / 2012 P1 Q1 / 2013 P1 Q3 construction that previously fell into the undefined boundary between this branch and Branch 2 and cost ~5 containment misses.

#### Sub-branch: same region + quality/vintage differentiation (single-variety ladders only)
...
- **Evidence:** 2015 P1 Q1, 2018 P1 Q3, 2023 P1 Q1, 2024 P1 Q1. *(2019 P1 Q2 was removed from this list 2026-08-06: its stem is a 6-wine, 3-country **paired grid** ("paired by country. Each pair is from a different country") — this leaf's single-region ladder contained 1 of its 6 wines, while the pack's F4b/Branch 4.2 partly-linked universe would have contained ~5 of 6. The citation itself was the routing trap. Paired-grid stems go to Branch 4's paired-grid note / pack F4b.)*
...
#### Sub-branch: same region, different varieties (regional multi-variety tour — NEW 2026-08-06)
- **Trigger:** the stem links the wines by **region** ("from the same region of origin", "from the same country and region") AND states **different / multiple single grape varieties**. This is a recurring construction (three attested instances plus a same-country twin) that had no home: the ladder sub-branch above models single-variety verticals, and Branch 2's multi-variety logic is keyed to "same country" wording and never fired on region-worded stems. Stem wording wins: "region" + different varieties lands here.
- **Leaf:** STRONG SIGNAL: **Loire multi-variety tour** — Melon de Bourgogne (Muscadet), Sauvignon Blanc (Sancerre/Pouilly-Fumé/Menetou-Salon), Chenin Blanc (Vouvray/Savennières, including a sweet botrytis Layon-family wine as the flight's closer). PLAUSIBLE: **Alsace noble-variety tour** — Riesling, Gewurztraminer, Pinot Gris (including Vendanges Tardives), and **dry Muscat**, the fourth noble grape (three corpus appearances: 2011 P1 Q1, 2017 P1 Q4, 2023 P1 Q2 — absent from every P1 leaf before 2026-08-06). CURVEBALL: a New World single region spanning varieties — e.g. Marlborough Riesling + Chardonnay (2013 P1 Q3; NZ Riesling appears nowhere else in the corpus artifacts).
- **Evidence:** 2011 P1 Q1 (Alsace: Muscat, Riesling, Pinot Gris VT), 2012 P1 Q1 (Loire: Muscadet, Vouvray Chenin, Menetou-Salon SB, Coteaux du Layon Chenin), 2013 P1 Q3 (Marlborough: Riesling + Chardonnay), and 2017 P1 Q1 ("same country and region" — Loire: Muscadet, Savennières Chenin, Pouilly-Fumé SB) as the construction's same-country-worded twin.
- **Practical rule:** the Branch 2 Loire-triangle rule ("Muscadet/Melon is the key survivor") applies here in full — it was written for exactly this construction, but was gated on "same country" wording and never fired on a "same region" stem before this sub-branch existed.

### Branch 4: mixed-bag / different countries, different varieties
**Historical frequency:** 7 of 40 P1 questions use open-field identification logic, especially the last question of the paper (2015 P1 Q3, 2016 P1 Q5, 2018 P1 Q2, 2019 P1 Q3, 2022 P1 Q4, 2023 P1 Q2, 2024 P1 Q2, 2025 P1 Q4). **2026 P1 Q3 does NOT belong in this branch** despite being the paper's closing flight — unlike a true mixed bag, it carries an explicit, tight geographic constraint ("regions influenced by the Mediterranean Sea") rather than an open field. It gets its own branch (Branch 5, below). As of 2026-08-06 this branch also hosts the **paired-grid** sub-branch (wines paired by country/variety — 2019 P1 Q2, 2014 P1 Q3), relocated from Branch 3's evidence list where it could not be contained.

**Method/style-dominant gate (2026-08-06 routing sweep):** before applying the leaf below, check the marks. If the stem explicitly de-emphasises origin ("Do not spend time thinking about the wine's specific origin" — 2019 P1 Q3), frames the ask as "human inputs versus natural factors" (2025 P1 Q4), or weights method/style/commercial marks above identification (2024 P1 Q2: method 3x7 + style/commercial 3x12 vs ID 3x6), defer to the **pack's F5 family** first — its production-archetype universe is built for these stems. When "different varieties" wording and marks-weighting both fire, the marks-weighting wins. Previously the master tree reached these three questions only via this branch's evidence list and the Curveball cases — there was no Layer A trigger for them at all.

#### Sub-branch: identification marks high, no linking constraint
- **Leaf:** STRONG SIGNAL: aromatic or textural whites that are regionally signature but not impossible. PLAUSIBLE: Riesling, Chenin Blanc, Viognier, Semillon, Albarino, Gruner Veltliner, Garganega, Torrontes, **Chardonnay** (back-filled 2026-08-06 — the paper's #1 variety appeared in this branch's own evidence questions, 2013 P1 Q5 and 2023 P1 Q2, yet the leaf omitted it while the F4 pack's textural/oaked slot carried it), **Roussanne** (varietal, Saint-Péray/N. Rhône — 2022 P1 Q4, one of this leaf's own cited evidence questions; before 2026-08-06 varietal Roussanne existed only inside Branch 2's France distribution and the F3 blend family, so a correctly-routed candidate could never shortlist it), **dry Muscat (Alsace)** (three corpus appearances — 2011 P1 Q1, 2017 P1 Q4, 2023 P1 Q2, the latter two being this branch's own evidence questions). CURVEBALL: Gewurztraminer (Alsace, Alto Adige — and once New World: Nelson NZ, 2016 P1 Q5, the tree's only attested New World aromatic curveball), Chinuri/qvevri, orange/oxidative whites, Vin Santo-style dry/sweet crossover, Moschofilero (Mantinia, Greece — 2024 P1 Q2; before 2026-08-06 the only Greek white anywhere in the artifacts was Assyrtiko), Viognier from Australia (Eden Valley — 2024 P1 Q2, 2014 P1 Q1; "Condrieu/new-world" lists never named Australia), **Cortese** (Gavi, Piedmont — 2013 P1 Q5, a different-countries breadth flight that routes here by default; the 2026-08-06 back-fill placed Cortese only in Branch 2's Italy CURVEBALL row, which a different-countries stem can never reach. For the fuller Italian secondary-white set — Arneis, Cortese, Moscato d'Asti — cross-reference Branch 2's Piedmont-whites row).
...
#### Sub-branch: paired grid — wines paired by country or variety (relocated home, 2026-08-06)
- **Trigger:** the stem sorts the flight into **pairs** sharing a country ("paired by country. Each pair is from a different country" — 2019 P1 Q2) or asks the candidate to divide wines into varietal pairs (2014 P1 Q3, on Branch 0's documented unroutable list). This is the pack's **F4b / Branch 4.2 partly-linked** shape: treat each local pair as a sub-question, and do not let one pair pull the whole flight toward one origin.
- **Leaf (per-country pair universes, from 2019 P1 Q2 — the construction's only routed instance):** PLAUSIBLE: Spain pair — mature white Rioja (Viura) + Albariño (Rías Baixas); Italy pair — Grillo (Sicily) + **Moscato d'Asti** (sweet frizzante Piedmont — before 2026-08-06 Muscat existed in the tree only as USA commodity Moscato, so a sweet Asti wine in P1 was entirely unmodelled); Australia pair — Clare/Watervale Riesling + Adelaide Hills Chardonnay. CURVEBALL: any pairing that reuses the mainstream F1 universes at regional level (Sancerre + Marlborough SB, Chablis + Kumeu Chardonnay — 2014 P1 Q3).
- **Evidence:** 2019 P1 Q2 (previously mis-claimed by Branch 3's single-region ladder via its own evidence citation — contained 1/6 there; the trap is that "paired" + region words drag the stem toward Branch 3, but a multi-country grid is breadth logic, not ladder logic), 2014 P1 Q3 (two-variety pairing grid; fell to Branch 0 correctly before this sub-branch existed).
...
- **Lychee/rose, overt perfume, low-acid broad palate**
  - survive: Gewurztraminer. eliminate Chardonnay, Riesling, Sauvignon Blanc. Region note (2026-08-06): default Alsace/Alto Adige, but 2016 P1 Q5 was Nelson, New Zealand — a New World aromatic is a live curveball, not an impossibility. Evidence base: 2016 P1 Q5, 2022 P1 Q3.
- **Grapey/floral perfume (orange blossom, fresh grape, elderflower) + DRY palate + moderate acid + light-to-mid body, no oak**
  - survive: dry Muscat, Alsace (the fourth noble grape — distinguish from Gewurztraminer by lighter body, fresher acid, grape-not-lychee aromatics, and no oily phenolic breadth; distinguish from Torrontés by restraint and Old World dryness). eliminate: Gewurztraminer, Torrontés, Viognier. Evidence base: 2011 P1 Q1, 2017 P1 Q4, 2023 P1 Q2 — three corpus misses before this cue existed (added 2026-08-06).
...
### Branch 7: "same producer" flights (added 2026-08-06 routing sweep)

- **The gap:** "same producer" is the most specific constraint a stem can carry, yet the master tree
  had no Layer A branch triggered by it — 2022 P1 Q1 would have fallen to Branch 0 under this tree
  alone, and 2021 P1 Q3 was dragged into Branch 1's same-variety leaves (worse, cited in the
  3-4-wine evidence list despite being a 2-wine question), missing both Wachau wines.
- **Trigger:** the stem says the wines are from the **same producer** — usually with same variety
  and/or same region/vintage also stated. Route here regardless of what else fires; then work the
  pack's F7 family (Branch 7.1 / F7b — same producer, multiple cuvées).
- **Leaf:** the construction is a producer's own quality/classification ladder — two rungs of one
  house's range, same grape. STRONG SIGNAL: Burgundy white tier ladder (village/lieu-dit vs Grand
  Cru — 2022 P1 Q1: Meursault village vs Corton-Charlemagne GC, same vintage); **Wachau Vinea
  Wachau ladder (Steinfeder → Federspiel → Smaragd)** — 2021 P1 Q3: Federspiel vs Smaragd Riesling,
  the corpus's other attested instance, absent from every F7 ladder until 2026-08-06 even though
  Wachau Riesling was STRONG elsewhere in the tree. PLAUSIBLE: German VDP ladder (Kabinett → GG),
  Alsace house range (classic → Grand Cru/lieu-dit), Cape Chenin producer range (entry → Old Vine
  Reserve). CURVEBALL: producer hierarchies not aligned with legal classification.
- **Evidence:** 2021 P1 Q3 ("the same producer, the same grape variety and the same region of
  origin"), 2022 P1 Q1 ("from the same producer and the same vintage").
- **Practical rule:** read for tier separation (site specificity, concentration, ripeness category,
  oak/lees spend, length), not for geography — the stem has already fixed the place. Two attested
  instances, both Old World ladders; treat the New World variants as widening options.
...
2026-08-06 routing-sweep fix pass (`outputs/backtest_reports/routing_sweep_2026-08-06.md`): re-plumbed the P1 routing layer against all 55 swept stems — new same-region-different-varieties sub-branch (Branch 3) and same-producer branch (Branch 7), a paired-grid home under Branch 4, cross-country-blend and method/style-dominant gates, evidence-list de-duplication (2016 P1 Q2, 2019 P1 Q1, 2019 P1 Q2, 2021 P1 Q3, 2025 P1 Q1), gate/leaf sync (Austria, New Zealand), and tiered knowledge back-fill (dry Alsace Muscat, Marsanne, varietal Roussanne, Piedmont whites, Moschofilero, NZ Riesling, Australian Viognier, Napa SB).

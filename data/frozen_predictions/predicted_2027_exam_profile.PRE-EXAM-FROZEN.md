...
- Predicted structure mix: `{'p1:F1:same_variety_cross_origin': 1, 'p1:F7:quality_calibration': 1, 'p1:F2:same_origin_comparative': 1}`
- Balance model: `{'repeated_families': [], 'family_recurrence_gaps': {'F1': 1, 'F7': 1, 'F2': 2}, 'diversity_warning': False}`

### Slot-by-slot guidance

- Q1: `p1:F1:same_variety_cross_origin`
  - likely varieties: `['chardonnay', 'riesling', 'sauvignon blanc']`
...
- Q2: `p1:F7:quality_calibration`
  - likely varieties: `['chardonnay', 'riesling', 'rhone_white_blend']`
  ...
  - likely commercial tier: `['specialist_premium', 'commercial', 'fine_wine']`
  - likely maturity role: `['young_primary', 'developing', 'mature_tertiary']`
  - likely curveball level: `['low', 'high', 'medium']`
...
- Predicted question count: `3`
- Predicted structure mix: `{'p2:F2:same_origin_comparative': 1, 'p2:F7:quality_calibration': 1, 'p2:F2:same_region_internal_diversity': 1}`
- Balance model: `{'repeated_families': ['F2'], 'family_recurrence_gaps': {'F2': 1, 'F7': 1}, 'diversity_warning': True}`

### Slot-by-slot guidance

- Q1: `p2:F2:same_origin_comparative`
  - likely varieties: `['bordeaux_red_family', 'cabernet franc', 'gamay']`
...
- Q2: `p2:F7:quality_calibration`
  - likely varieties: `['bordeaux_red_family', 'pinot noir', 'syrah']`
  - likely countries: `['France', 'Italy', 'USA']`
  - likely styles: `['still_dry', 'fortified']`
  ...
  - likely maturity role: `['developing', 'mature_tertiary', 'young_primary']`
  - likely curveball level: `['low', 'high', 'medium']`
- Q3: `p2:F2:same_region_internal_diversity`
  - likely varieties: `['bordeaux_red_family', 'pinot noir', 'syrah']`
  - likely countries: `['France', 'Italy', 'USA']`
  - likely styles: `['still_dry', 'fortified']`
  - likely wine roles: `['method_reference', 'maturity_reference', 'benchmark_anchor']`
  - likely benchmark status: `['benchmark_classic', 'nonbenchmark', 'iconic_benchmark']`
  - likely commercial tier: `['specialist_premium', 'commercial', 'fine_wine']`
  - likely maturity role: `['developing', 'mature_tertiary', 'young_primary']`
  - likely curveball level: `['low', 'high', 'medium']`
...
- Balance model: `{'repeated_families': [], 'family_recurrence_gaps': {'F5': 1, 'F2': 1, 'F7': 4}, 'diversity_warning': False}`

### Slot-by-slot guidance

- Q1: `p3:F5:sparkling_method`
  - likely varieties: `['sparkling_classic_blend', 'chardonnay', 'riesling']`
  - likely countries: `['France', 'Spain', 'Italy']`
  - likely styles: `['sparkling', 'still_dry', 'still_sweet']`
  - likely wine roles: `['method_reference', 'maturity_reference', 'sweetness_reference']`
  - likely benchmark status: `['iconic_benchmark', 'benchmark_classic', 'nonbenchmark']`
  - likely commercial tier: `['specialist_premium', 'commercial', 'fine_wine']`
...
- Q2: `p3:F2:same_origin_comparative`
  - likely varieties: `['chardonnay', 'sauvignon blanc', 'sparkling_classic_blend']`

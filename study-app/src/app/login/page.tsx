...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center min-h-screen px-6 py-10">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="border border-border rounded-lg p-4 bg-card/50 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => setShowTavilyHelp(true)}
                  className="text-xs text-accent hover:text-accent-hover underline underline-offset-2 cursor-pointer transition-colors"
                >
                  How do I get a key?
                </button>
      ...
      {showTavilyHelp && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={() => setShowTavilyHelp(false)} />
          <div className="relative bg-card border border-border rounded-xl shadow-2xl max-w-lg w-full max-h-[85vh] overflow-y-auto p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-bold text-foreground">Getting Your Tavily API Key</h2>
              <button
                type="button"
                onClick={() => setShowTavilyHelp(false)}
                className="text-muted hover:text-foreground transition-colors cursor-pointer p-1"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
            ...
            <div className="space-y-4 text-sm text-muted leading-relaxed">
              <div className="flex gap-3">
                <span className="shrink-0 w-6 h-6 rounded-full bg-accent text-background flex items-center justify-center text-xs font-bold">1</span>
                <div>
                  <p className="text-foreground font-medium">Create a Tavily account</p>
                  <p>
                    Go to{" "}
                    <a href="https://app.tavily.com/" target="_blank" rel="noopener noreferrer" className="text-accent hover:text-accent-hover underline underline-offset-2">
                      app.tavily.com
                    </a>{" "}
                    and sign up with your email or Google account. If you already have an account, just sign in.
                  </p>
              ...
              <div className="flex gap-3">
                <span className="shrink-0 w-6 h-6 rounded-full bg-accent text-background flex items-center justify-center text-xs font-bold">2</span>
                <div>
                  <p className="text-foreground font-medium">Open your dashboard</p>
                  <p>
                    Once signed in you land on{" "}
                    <a href="https://app.tavily.com/home" target="_blank" rel="noopener noreferrer" className="text-accent hover:text-accent-hover underline underline-offset-2">
                      app.tavily.com/home
                    </a>
                    . Find the <strong className="text-foreground">API Keys</strong> section right on the front page.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-foreground font-medium">Create an API key</p>
                  <p>
                    Click the <strong className="text-foreground">+</strong> button in the API Keys section, give the key a name
                    (e.g. &ldquo;MW Study App&rdquo;), and copy it.
                  </p>
                  <p className="mt-1.5">
                    The key starts with <code className="bg-background px-1.5 py-0.5 rounded text-xs font-mono text-foreground">tvly-...</code>
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <p className="text-foreground font-medium">Paste it here</p>
                  <p>
                    Paste your key into the field on the registration form. It&apos;s encrypted before storage and only used to run web research on your behalf.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-background border border-border rounded-lg p-3 mt-2">
                <p className="text-xs">
                  <strong className="text-foreground">Why Tavily?</strong> The app uses Tavily to pull real-world sources into your study
                  materials &mdash; producer tech sheets, critic tasting notes, and stockists near you. Tavily&apos;s free plan includes a
                  monthly credit allowance that comfortably covers typical study use. Without a key, AI features still work but skip live web research.
                </p>
              </div>
            </div>

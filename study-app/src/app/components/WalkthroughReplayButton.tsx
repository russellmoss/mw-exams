...
// walkthrough also has its own button in the Practical header, next to the two things it explains.
...
export function WalkthroughReplayButtons() {
  const [open, setOpen] = useState<"diagrams" | "coach" | "practical" | null>(null);

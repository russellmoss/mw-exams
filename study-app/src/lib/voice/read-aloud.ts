 ...
 *
 * `toSpeakable` emits no tags today — the pronunciation lexicon this guard was written for was left
 * behind in the port (see speech.ts for why). It is kept because the failure it prevents is silent
 * and ugly: ship half a tag to ElevenLabs and the fragment is read out as literal text. Anyone
 * adding a respelling or SSML pass later gets this for free rather than rediscovering it.
 */
